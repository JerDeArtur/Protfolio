            ...
            modelBuilder.Entity("MASP.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdPilot2 = 2,
                            IdPlane = 1,
                            LandingDate = new DateTime(2021, 6, 13, 0, 28, 4, 999, DateTimeKind.Local).AddTicks(738),
                            Line = 1,
                            Price = 200.0,
                        ...
                        new
                        {
                            ...
                            IdPilot2 = 1,
                            IdPlane = 2,
                            LandingDate = new DateTime(2021, 6, 13, 0, 28, 4, 999, DateTimeKind.Local).AddTicks(2363),
                            Line = 2,
                            Price = 100.0,
                            TakeOffDate = new DateTime(2021, 6, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            To = "Warsaw"
            ...
            modelBuilder.Entity("MASP.Models.Plane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdPlane = 1,
                            IdAirport = 1,
                            LastRepair = new DateTime(2021, 6, 13, 0, 28, 5, 23, DateTimeKind.Local).AddTicks(6493),
                            SeatsCount = 200
                        },
                        new
                        {
                            IdPlane = 2,
                            IdAirport = 2,
                            LastRepair = new DateTime(2021, 6, 13, 0, 28, 5, 23, DateTimeKind.Local).AddTicks(7339),
                            SeatsCount = 100
                        });
                });
