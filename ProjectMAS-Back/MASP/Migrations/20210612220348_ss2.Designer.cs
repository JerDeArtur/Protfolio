...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MASP.Models.Flight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdPilot2 = 2,
                            IdPlane = 1,
                            LandingDate = new DateTime(2021, 6, 13, 0, 3, 47, 631, DateTimeKind.Local).AddTicks(6770),
                            Line = 1,
                            Price = 200.0,
                        ...
                        new
                        {
                            ...
                            IdPilot2 = 1,
                            IdPlane = 2,
                            LandingDate = new DateTime(2021, 6, 13, 0, 3, 47, 631, DateTimeKind.Local).AddTicks(8495),
                            Line = 2,
                            Price = 100.0,
                            TakeOffDate = new DateTime(2021, 6, 13, 0, 0, 0, 0, DateTimeKind.Local),
                            To = "Warsaw"
            ...
            modelBuilder.Entity("MASP.Models.Plane", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdPlane = 1,
                            IdAirport = 1,
                            LastRepair = new DateTime(2021, 6, 13, 0, 3, 47, 656, DateTimeKind.Local).AddTicks(3400),
                            SeatsCount = 200
                        },
                        new
                        {
                            IdPlane = 2,
                            IdAirport = 2,
                            LastRepair = new DateTime(2021, 6, 13, 0, 3, 47, 656, DateTimeKind.Local).AddTicks(4860),
                            SeatsCount = 100
                        });
                });
            ...
            modelBuilder.Entity("MASP.Models.Ticket", b =>
                {
                    ...
                    b.Property<int?>("AirportIdAirport")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AirportIdAirport");

                    b.HasIndex("FlightIdFlight");
            ...
            modelBuilder.Entity("MASP.Models.Ticket", b =>
                {
                    b.HasOne("MASP.Models.Airport", null)
                        .WithMany("Tickets")
                        .HasForeignKey("AirportIdAirport");

                    b.HasOne("MASP.Models.Flight", "Flight")
                        .WithMany("Tickets")
                        .HasForeignKey("FlightIdFlight");
